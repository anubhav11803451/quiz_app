...
import 'package:quizapp/model/hardquiz.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';


class MainScreen_h extends StatefulWidget {
  MainScreen_h({Key key}) : super(key: key);
  @override
  _MainScreen_hState createState() => _MainScreen_hState();
}

class _MainScreen_hState extends State<MainScreen_h> {
  ...
  Widget build(BuildContext context) {
    Future<void> fetchQuestions() async {
      var response = await http.get(url_h);
