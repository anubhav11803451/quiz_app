...
import 'package:quizapp/model/mediumquiz.dart';
import 'package:font_awesome_flutter/font_awesome_flutter.dart';


class MainScreen_m extends StatefulWidget {
  MainScreen_m({Key key}) : super(key: key);
  @override
  _MainScreen_mState createState() => _MainScreen_mState();
}

class _MainScreen_mState extends State<MainScreen_m> {
  ...
  Widget build(BuildContext context) {
    Future<void> fetchQuestions() async {
      var response = await http.get(url_m);
